 ...
 * Resultado: 10001000b
 */
void test_Bfx_CtrlBit_u8u8()
{
    uint8 Esperado = 0x88;  // 10001000b
    uint8 Data = 0x8A;      // 10001010b
    uint8 BitPin = 0x01;
    Bfx_CtrlBit_u8u8(&Data, BitPin);
    TEST_ASSERT_EQUAL_UINT8(Esperado, Data);
}
 ...
 * Resltado: 11110111b
 */
void test_Bfx_PutBit_u8u8_SetTRUE()
{
    uint8 Esperado = 0xF7;  // 11110111
    uint8 Data = 0xE7;      // 11100111
    uint8 BitPn = 0x04;
    Bfx_PutBit_u8u8(&Data, BitPn, TRUE);
}
 ...
 * Resltado: 11100011b
 */
void test_Bfx_PutBit_u8u8_SetFALSE()
{
    uint8 Esperado = 0xE3;  // 11100011
    uint8 Data = 0xE7;      // 11100111
    uint8 BitPn = 0x02;
    Bfx_PutBit_u8u8(&Data, BitPn, FALSE);
}
